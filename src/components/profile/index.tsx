      ...
      <ProfileComponent>
        <ProfileGeneral>
          <div className="info">
            ...
            <p>
              1996年、山口県山口市出身。徳山工業高等専門学校専攻科を経て、筑波大学大学院図書館情報メディア研究科博士前期課程修了。
              <br />
              高専在学中にU-22プログラミング・コンテストにて経済産業省商務情報政策局長賞を受賞。2019年より、ピクシーダストテクノロジーズ株式会社にてエンジニアとして従事し、建設現場向けアプリケーションの開発に携わる。2020年、山口県の地域・企業における課題をITを利用して解決するエンドルフィニクス合同会社を設立。2022年、ソニーグループ株式会社R＆Dセンター入社。
              <br />
              中学生の時から写真を趣味としており、2020年に初の個展「碧の風景」を開催。2021年6月度
              日本カメラ月例フォトコンテスト Webの部 入選。
            </p>
          </div>
        ...
        <Topics>
          ...
          <div>
            ...
            <p className="topic_text">dreamexp834[at]gmail.com</p>
          </div>
        </Topics>
        <Topics>
          <h3>EDUCATIONS</h3>
          ...
          <div>
            ...
            <p className="topic_text">
              徳山工業高等専門学校 専攻科 情報電子工学専攻（古賀崇了 研究室）
            </p>
          </div>
          <div>
        ...
        <Topics>
          ...
          <div>
            <p className="topic_head">2022 - 2023</p>
            <p className="topic_text">
              Sony Group Corporation R＆D Center (Full-Time R＆D Engineer)
            </p>
          </div>
          <div>
            <p className="topic_head">2023 -</p>
            <p className="topic_text">
              Sony Corporation Technology Development Laboratory (Full-Time R＆D Engineer)
            </p>
          </div>
        </Topics>
        <Topics>
        ...
        <Topics>
          ...
          <div>
            ...
            <p className="topic_text">
              山陽新幹線「新大阪〜岡山」開業40周年「新幹線の思い出写真コンテスト」優秀賞 / 特別賞
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="topic_text">
              中国地区高専コンピュータフェスティバル アプリケーション部門 第一位
            </p>
          </div>
          <div>
            <p className="topic_head">2018</p>
        ...
        <Topics>
          <h3>PUBLICATIONS</h3>
          <div>
            <p className="topic_head">
              原著論文
              <br />
              (査読あり)
            </p>
            <p className="topic_text">
              Shunnosuke Kataoka, Noriaki Suetake and Takanori Koga, “Water Depth Estimation Using
              Measurement Distortion of Time-of-Flight Camera and Its Application to Interactive
              Art,” Innovative Computing, Information and Control Express Letters (ICIC Express
              Letters), Part B: Applications, Vol.12, No.7, 2021.07
            </p>
          </div>
          <div>
            <p className="topic_head">
            ...
            <p className="topic_text">
              片岡 駿之介, 古賀 崇了,
              “室内環境におけるToFカメラを用いた水深の多点同時測定に関する検討,” 信学技報, vol. 118,
              no. 346, SIS2018-24, pp. 17-20, 2018.12
            </p>
          </div>
          <div>
            <p className="topic_head">
            ...
            <p className="topic_text">
              片岡 駿之介, 古賀 崇了,
              “ToFカメラの計測歪みを利用した水深の推定と水を媒体とするインタラクションへの応用,”
              インタラクション2019論文集, 3P-76, pp. 972-973, 2019.02
            </p>
          </div>
        </Topics>
        <Topics>
          ...
          <div>
            ...
            <p className="topic_text">
              「かばんの中身と個性」 1/100展（2019年度 筑波大学大学院 コンテンツ制作論）
            </p>
          </div>
          <div>
            <p className="topic_head">2020</p>
          ...
          <div>
            <p className="topic_head">2023</p>
            <p className="topic_text">
              <a href="https://shunnosuke.com/minimalism_in_the_northern_land">
                写真展「MINIMALISM IN THE NORTHERN LAND」
              </a>
              （Kanda Coffee 本店）
            </p>
          </div>
        ...
        <Topics>
          ...
          <div>
            <p className="topic_text">
              「情報維新！やまぐち」, https://www.nhk.or.jp/yamaguchi/ishin/, NHK山口放送局,
              2017.11.16
            </p>
          </div>
          <div>
            <p className="topic_text">
              「夢色アサンブラ vol.125 徳山高専 片岡駿之介さん・松村俊志さん」, シティケーブル周南,
              2018.07.20
            </p>
          </div>
          <div>
          ...
          <div>
            <p className="topic_text">
              「株式会社トクヤマ 社内報 『あした葉』 No.651」, 株式会社トクヤマ, 2020.09
            </p>
          </div>
          <div>
            <p className="topic_text">
              「高専から筑波大編入で起業 -現役学生起業家によるトークイベント-」,
              つくばスタートアップパーク, 2020.09.08
            </p>
          </div>
        </Topics>
        <Topics>
